...
/////Preapare WiFi Channel
  ...
  wifiPhy.Set ("CcaMode1Threshold", DoubleValue(-81));               //receiving packets at -80 in the distance of 290, but not at 295
...
/* mobility.SetPositionAllocator ("ns3::RandomDiscPositionAllocator",
                                "X", StringValue ("500"),
                                "Y", StringValue ("500"),
                                "Rho", StringValue ("ns3::UniformRandomVariable[Min=290|Max=290]"),
